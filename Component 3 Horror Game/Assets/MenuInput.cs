// GENERATED AUTOMATICALLY FROM 'Assets/MenuInput.inputactions'
...
public class @MenuInput : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Menu"",
            ""id"": ""8cf0c854-258b-4494-bd7f-3d4f88bcf0b9"",
            ""actions"": [
                {
                    ""name"": ""Select"",
                    ""type"": ""Button"",
                    ""id"": ""daf0cacd-642f-4275-9d7f-fac175027ee3"",
                ...
                },
                {
                    ""name"": ""Back"",
                    ""type"": ""Button"",
                    ""id"": ""54ee6b92-641b-4709-8def-163a336e011b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Up"",
                    ""type"": ""Button"",
                    ""id"": ""c6546c87-fd2b-4664-8e33-1d9f0c089ba0"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Down"",
                    ""type"": ""Button"",
                    ""id"": ""0df94ec9-2259-4396-8505-4ccf88d70ac9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4252c4f4-8cac-4866-baae-b3dfd71db580"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c3c65f2d-62b6-48e6-ae14-7fe59f21ab3c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""87ad906b-23b2-495a-b2b8-1a1e639d183f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""dcdde1fd-22e7-4aa9-9945-b017225d979c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""beb89aea-053f-4459-9eff-7f3818c668ca"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ebbdd00f-acee-44e6-b944-740b8e2a798a"",
